...
export {
  mutations.typeDefs, typeDefs, CommenttypeDefs, Commentresolvers, UsertypeDefs, Userresolvers,
};

export default {
  typeDefs, CommenttypeDefs, Commentresolvers, UsertypeDefs, Userresolvers,
};
